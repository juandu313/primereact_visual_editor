...
export class Documentation extends Component {
    ...
    render() {
        return (
            <div className="p-grid documentation">
                <div className="p-col-12">
                    <div className="card">
                        <h1>Getting Started</h1>
                        <h5>Current Version</h5>
                        <p>React 16 and PrimeReact 6.6.0</p>
...
`}
                        ...
                        <p>Designer also provides exclusive premium themes that requires a license. These are Soho-Light, Soho-Dark, Viva-Light, Viva-Dark, Mira and Nano themes with full SASS code included in <i>src/assets/themes/</i> folder.</p>
